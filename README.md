...
[![Licencia](https://img.shields.io/badge/Licencia-AGPLv3-blue)](LICENSE)

---

## 📸 Captura

> _Aplicación de escritorio para asignar profesores a tareas de apoyo (recogida de materiales, vigilancia, clasificación, etc.) usando optimización combinatoria._
...
git clone https://github.com/sergarb1/GeneradorCuadranteTareas.git
cd GeneradorCuadranteTareas
...
├── seed_data.py        # 🌱 Datos de ejemplo (15 profes, 50 tareas)
...
- 🌐 **Página del proyecto en GitHub Pages** → [https://sergarb1.github.io/GeneradorCuadranteTareas](https://sergarb1.github.io/GeneradorCuadranteTareas)
...
**Desarrollado para centros educativos**
